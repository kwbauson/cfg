...
with builtins; with pkgs.mylib; {
    ...
    drvsExcept
      {
        ...
        ${attrIf isGraphical "graphical"} = {
          graphical-core = {
            inherit
              arandr dzen2 graphviz i3-easyfocus i3lock imagemagick7 scrot sway
              sxiv xclip xdotool xsel xterm wine
              ;
      ...
      ${attrIf isDarwin "darwin"} = {
        inherit
          ...
          wine zathura obs-studio obs-v4l2sink breeze-icons ccache dzen2
          ;
  ...
  xdg = {
    ...
    configFile = {
      ...
      "nix/nix.conf".text = ''
        # extra-substituters = http://kwbauson.com:5000
        # extra-trusted-public-keys = kwbauson.com:J/gtSLKCUg8HcZLaHxSse7JL4thcZVrmhqC+HZVZdaU=
  ...
  home.file.authorized_keys = {
    ...
    text = ''
      ...
      ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPJtcd3xL1BR1RSFzin0Im+HUk6kTWj44wJ56uWxkPM0 keith@kwbauson
      ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAILaLZgemYIGQD0yvRU38tvYR4Hp4nLAdZMj9jgwS+p0y keith@keith-vm
      ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHP+Qko2pm1c2VgfCxCgBjSNk9xvVxjn7gd6HaUQ8JoB keithbauson@keith-mac.local
    '';
  };
