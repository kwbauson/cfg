...
let
  sources = {
    ...
    "concurrently-6.0.2" = {
      ...
      version = "6.0.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/concurrently/-/concurrently-6.0.2.tgz";
        sha512 = "u+1Q0dJG5BidgUTpz9CU16yoHTt/oApFDQ3mbvHwSDgMjU7aGqy0q8ZQyaZyaNxdwRKTD872Ux3Twc6//sWA+Q==";
      };
    };
