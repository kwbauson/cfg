...
let
  sources = {
    ...
    "coc-explorer-0.13.0" = {
      ...
      version = "0.13.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/coc-explorer/-/coc-explorer-0.13.0.tgz";
        sha512 = "zWYcEMV74L/vnW1oA7XUudkZUxJikJG3QRo4nvLFa2gwJwI+yghynKaud43PxzQjXytbDhjXPWwM7jX0AjWsaQ==";
      };
    };
    "coc-pyright-1.1.95" = {
      name = "coc-pyright";
