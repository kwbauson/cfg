...
let
  sources = {
    ...
    "@types/node-16.4.4" = {
      ...
      version = "16.4.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-16.4.4.tgz";
        sha512 = "BH/jX0HjzElFCQdAwaEMwuGBQwm6ViDZ00X6LKdnRRmGWOzkWugEH4+7a0BwfHQ8DfPPCSd/mdsm3Nu8FKFu0w==";
      };
    };
