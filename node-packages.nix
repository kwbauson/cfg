...
let
  sources = {
    ...
    "ts-node-dev-1.1.3" = {
      ...
      version = "1.1.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/ts-node-dev/-/ts-node-dev-1.1.3.tgz";
        sha512 = "z+nRf+lnB9JnChBUrjMVhOO53lNcjfSsdoB53n8ErYQJsBwySkW2BHbuF/RZousu34ILUIa7gzyh2RI+SamP0w==";
      };
    };
    "tsconfig-7.0.0" = {
      name = "tsconfig";
