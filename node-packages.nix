...
let
  sources = {
    ...
    "@types/node-16.4.2" = {
      ...
      version = "16.4.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-16.4.2.tgz";
        sha512 = "vxyhOzFCm+jC/T5KugbVsYy1DbQM0h3NCFUrVbu0+pYa/nr+heeucpqxpa8j4pUmIGLPYzboY9zIdOF0niFAjQ==";
      };
    };
