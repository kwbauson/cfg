...
let
  sources = {
    ...
    "ts-node-dev-1.0.0" = {
      ...
      version = "1.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/ts-node-dev/-/ts-node-dev-1.0.0.tgz";
        sha512 = "leA/3TgGtnVU77fGngBwVZztqyDRXirytR7dMtMWZS5b2hGpLl+VDnB0F/gf3A+HEPSzS/KwxgXFP7/LtgX4MQ==";
      };
    };
    "tsconfig-7.0.0" = {
      name = "tsconfig";
