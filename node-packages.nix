...
let
  sources = {
    ...
    "coc-pyright-1.1.105" = {
      ...
      version = "1.1.105";
      src = fetchurl {
        url = "https://registry.npmjs.org/coc-pyright/-/coc-pyright-1.1.105.tgz";
        sha512 = "ajuF/J017OunKWG+4S7I/jmUI//a8/RhyOVKDqsl8d7FcE6OkbQ2o+rSRAQBleAl0eLCFRcfFVbJtMZlbK3BHA==";
      };
    };
    "concat-map-0.0.1" = {
      name = "concat-map";
