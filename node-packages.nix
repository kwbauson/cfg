...
let
  sources = {
    ...
    "concurrently-6.1.0" = {
      ...
      version = "6.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/concurrently/-/concurrently-6.1.0.tgz";
        sha512 = "jy+xj49pvqeKjc2TAVXRIhrgPG51eBKDZti0kZ41kaWk9iLbyWBjH6KMFpW7peOLkEymD+ZM83Lx6UEy3N/M9g==";
      };
    };
    ...
    "date-fns-2.21.0" = {
      ...
      version = "2.21.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/date-fns/-/date-fns-2.21.0.tgz";
        sha512 = "lbAFpaKz7QuVxm6m1rmioh4BB2gmLx1r1JMYXU2A/ufT5ly4zEG7HYH4fvS/QfbdyC5rkYyiS30mYz4Q7XCO+w==";
      };
    };
    "dateformat-1.0.12" = {
      name = "dateformat";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."concurrently-6.1.0"
      sources."create-require-1.1.1"
      sources."currently-unhandled-0.4.1"
      sources."date-fns-2.21.0"
