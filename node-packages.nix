...
let
  sources = {
    ...
    "coc-explorer-0.13.7" = {
      ...
      version = "0.13.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/coc-explorer/-/coc-explorer-0.13.7.tgz";
        sha512 = "Dy6XbTIDFThZPYpJtgiuhFM/VO0qHyAyWWih40MMUD9dJwHU23eTP7sGcA2Dlj4vVjXrDrCABSVZTv2KQT+xLA==";
      };
    };
    "coc-pyright-1.1.96" = {
      name = "coc-pyright";
