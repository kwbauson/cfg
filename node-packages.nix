...
let
  sources = {
    ...
    "@types/node-16.4.8" = {
      ...
      version = "16.4.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-16.4.8.tgz";
        sha512 = "VL7RZyCpfYEmbyd3/Eq5RNYhZt7yoL1JThZQ3KzimzhLya2Qa86U1ZZmioNWAAjiz99z1ED1xF9NUV2srvfVrA==";
      };
    };
