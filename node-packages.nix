...
let
  sources = {
    ...
    "ts-node-dev-1.1.2" = {
      ...
      version = "1.1.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/ts-node-dev/-/ts-node-dev-1.1.2.tgz";
        sha512 = "9EOZgYVS1dn/QPGJ5vXz7KxvBYTWpjSfQHRE0ryFsn8EpOLb5tuJakVp9Y4amQWsivTptNdzOu6dEjI0vtS0hA==";
      };
    };
    "tsconfig-7.0.0" = {
      name = "tsconfig";
