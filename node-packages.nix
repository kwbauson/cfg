...
let
  sources = {
    ...
    "coc-deno-0.11.0" = {
      name = "coc-deno";
      packageName = "coc-deno";
      version = "0.11.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/coc-deno/-/coc-deno-0.11.0.tgz";
    ...
    "coc-explorer-0.15.0" = {
      ...
      version = "0.15.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/coc-explorer/-/coc-explorer-0.15.0.tgz";
        sha512 = "1Xk8+969TgOdITU1NhyeBRgRWu8RNZtkAma+6WCJmHldxVIa/0SViRXiMYuGxB8EpwfbaguaayHx6wzdrA1saQ==";
      };
    };
    "coc-pyright-1.1.106" = {
      name = "coc-pyright";
      ...
      version = "1.1.106";
      src = fetchurl {
        url = "https://registry.npmjs.org/coc-pyright/-/coc-pyright-1.1.106.tgz";
        sha512 = "NK4JZ/0XuYB1BFT/bUYbsI2KeKReFc3TKhd1OpyMd4P2XI2H+H6/cy+XlHOvCl8wBy+50Blw2JDaNnpinH7dHA==";
      };
    };
    "concat-map-0.0.1" = {
      name = "concat-map";
    ...
    "import-maps-0.2.4" = {
      name = "import-maps";
      packageName = "import-maps";
      version = "0.2.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/import-maps/-/import-maps-0.2.4.tgz";
        sha512 = "31ZDO53RS3HcZUDIj8OMNuFr6gXkc6wsK+lTZosZuT8CDF/Y1Hk2gAJ6X+bdiEZoj8GkRN+nS5hFZQuOl0f29g==";
      };
    };
    "indent-string-2.1.0" = {
      name = "indent-string";
    ...
    "pyright-1.1.106" = {
      ...
      version = "1.1.106";
      src = fetchurl {
        url = "https://registry.npmjs.org/pyright/-/pyright-1.1.106.tgz";
        sha512 = "28VWOLjtLKe87a5MTvdaryGahI79sqfYgi6LZid5iMdIMQj4LQlHFy1EqQKiBJm7WsrjLwckEfv5jVE+7+tYeQ==";
      };
    };
    "read-pkg-1.1.0" = {
      name = "read-pkg";
    ...
    "typescript-deno-plugin-1.31.0" = {
      ...
      packageName = "typescript-deno-plugin";
      version = "1.31.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/typescript-deno-plugin/-/typescript-deno-plugin-1.31.0.tgz";
        sha512 = "IoF5c8EubyNgjxxarguZfMx8Ph9Av9XqjySop0orepXv8wr02ND3DNNDFFdQyZfQAAcv1/v/u14MQIp8Os4c1w==";
      };
    };
    "user-home-2.0.0" = {
      name = "user-home";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."coc-explorer-0.15.0"
      sources."coc-pyright-1.1.106"
